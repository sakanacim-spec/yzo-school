...
const LANDING_I18N: Record<string, any> = {
  fr: {
    nav: { features: "Fonctionnalités", partners: "Partenaires", login: "ACCÉDER À MON ESPACE", loginMobile: "CONNEXION" },
  ...
  en: {
    nav: { features: "Features", partners: "Partners", login: "GO TO MY SPACE", loginMobile: "LOGIN" },
    ...
    features: { subtitle: "Key Features", title: "All school tracking gathered in one interface", f1_title: "Report Cards & Grades", f1_desc: "View grades as soon as they are entered. Download and verify official report cards in a secure PDF format.", f2_title: "Attendance & Absences", f2_desc: "Track attendance in real-time. Get instantly notified in case of an absence or delay.", f3_title: "School Workspaces", f3_desc: "Complete interface for principals and secretaries: manage enrollments and billing." },
  ...
  es: {
    nav: { features: "Funciones", partners: "Socios", login: "ACCEDER A MI ESPACIO", loginMobile: "ACCEDER" },
    ...
    features: { subtitle: "Funciones clave", title: "Todo el seguimiento escolar en una sola interfaz", f1_title: "Boletines y Notas", f1_desc: "Visualice las notas apenas se ingresan. Descargue y verifique los boletines oficiales en PDF seguro.", f2_title: "Asistencias y Ausencias", f2_desc: "Haga seguimiento de la asistencia en tiempo real. Sea notificado de inmediato en caso de ausencia.", f3_title: "Espacios para Escuelas", f3_desc: "Interfaz completa para directores y secretarias: gestión de inscripciones y facturación." },
  ...
  ar: {
    nav: { features: "الميزات", partners: "الشركاء", login: "تسجيل الدخول", loginMobile: "دخول" },
    ...
    features: { subtitle: "الميزات الرئيسية", title: "كل التتبع المدرسي مجموع في واجهة واحدة", f1_title: "النتائج والدرجات", f1_desc: "شاهد الدرجات بمجرد إدخالها. قم بتنزيل والتحقق من النتائج الرسمية بصيغة PDF آمنة.", f2_title: "الحضور والغياب", f2_desc: "تتبع الحضور في الوقت الفعلي. احصل على إشعار فوري في حالة الغياب أو التأخير.", f3_title: "مساحات المؤسسات", f3_desc: "واجهة كاملة للمديرين والسكرتارية: إدارة التسجيل والفوترة." },
