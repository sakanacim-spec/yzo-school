...
export const en = {
  ...
  dashboard: {
    ...
    executiveDashboardDesc: 'Real-time executive dashboard: analyze recovery, financial projections, and overall performance by cycle.',
    monthlyReport: 'Monthly Report',
    showFigures: 'Show figures',
    hideFigures: 'Hide figures',
    ...
    recoveryProgress: 'Recovery progress over the year',
    ...
    importExcelOrWait: 'Import an Excel file or wait if a synchronization is in progress. Verify that you are connected to the internet.',
    hiddenData: 'Hidden data',
    annualTotal: 'Annual total',
    paymentsReceived: 'Payments received',
    recovered: 'recovered',
    toRecover: 'To recover',
    studentsClockedIn: 'Students clocked in',
  ...
  // Bulletin PDF — Generated document labels
  bulletin: {
    ...
    classGeneralAverage: 'Class overall average',
    absences: 'Absences',
    lates: 'Lates',
    councilDecision: 'Council decision',
    classTeacher: 'CLASS TEACHER',
    stampAndSignature: 'Stamp and signature',
    directorTitle: 'PRINCIPAL / DIRECTOR',
    sealAndSignature: 'Seal and signature',
    legalNotice: 'This report card is unique and no copy will be issued. To be kept carefully by the parent or guardian.',
    madeIn: 'Made in',
    the: 'on',
    generatedVia: 'Generated via yziow.com — School Management Platform',
    appVeryGood: 'Excellent',
    appGood: 'Good',
